namespace ToyRobot
{
    public class ToyRobot
    {
        ...
        public virtual void Left() => Facing = Facing.IsValid() ? Facing.RotateLeft() : null;

        public virtual void Right() => Facing = Facing.IsValid() ? Facing.RotateRight() : null;

        public virtual string Report() => IsValid(X, Y, Facing) ? $"{X},{Y},{Facing}" : null;
